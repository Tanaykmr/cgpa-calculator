...
export const subjectsData: SubjectsData = {
	...
	ECE: [
		...
		{
			subjectName: 'Microelectronics',
			subjectCode: 'ECC-305',
			paperId: '000',
			credits: 3,
		},
		{
			subjectName: 'Introduction to Control Systems',
			subjectCode: 'ECC-307',
			paperId: '000',
			credits: 3,
		},
		{
			subjectName: 'Transmission Lines, Waveguides and Antenna Design',
			subjectCode: 'ECC-309',
			paperId: '000',
			credits: 4,
		},
		...
		{
			subjectName: 'Digital Signal Processing Lab',
			subjectCode: 'ECC-351',
			paperId: '000',
			credits: 1,
		},
		{
			subjectName: 'Microelectronics Lab',
			subjectCode: 'ECC-353',
			paperId: '000',
			credits: 1,
		},
		{
			subjectName: 'Introduction to Control Systems Lab',
			subjectCode: 'ECC-355',
			paperId: '000',
			credits: 1,
		},
		{
			subjectName: 'Transmission Lines, Waveguides and Antenna Design Lab',
			subjectCode: 'ECC-357',
			paperId: '000',
			credits: 1,
		},
		{
			subjectName: 'Data Communication and Networking Lab',
			subjectCode: 'ECC-359',
			paperId: '000',
			credits: 1,
		},
